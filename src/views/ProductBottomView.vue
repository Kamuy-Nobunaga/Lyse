...
<div class="header">
    <h2>Bottom</h2>
    <p>Shop the best in trousers and pants with Glasgow based quality independent mens store Lyse.</p>
</div>
<div class="products">
    <div class="product" v-for="product in productStore.getBottom()" :key="product.id" @click="handleClick(product)">
